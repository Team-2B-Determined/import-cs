...
const DataStructures = () => {
  const items:Item[] = [
    ...
    {name:"Stacks", href:"/datastructures/single-element", body:"[More details about Stacks] \nQueues planned too", image:"https://cdn4.iconfinder.com/data/icons/miscellaneous-150-solid/128/series_category_array_list_sequence_file_folder_arrange-512.png"}
  ]
